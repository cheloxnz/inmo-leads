...
def build_contract_pdf():
    ...
    story.append(Paragraph("• 30 minutos de videollamada de handoff", styles['ContractBullet']))
    story.append(Paragraph("• El comprador configura integraciones con la documentación", styles['ContractBullet']))
    story.append(Spacer(1, 0.1*inch))
    story.append(Paragraph("<b>Plan Premium ($12,000):</b>", styles['ContractBody']))
    story.append(Paragraph("• 1 hora de videollamada de capacitación", styles['ContractBullet']))
